...
<div class="gavias-main-page">
   ...
   <?php require(drupal_get_path('theme', 'gavias_educar') . '/template/page/header.tpl.php'); ?>
	...
	<?php require(drupal_get_path('theme', 'gavias_educar') . '/template/page/footer.tpl.php'); ?>
