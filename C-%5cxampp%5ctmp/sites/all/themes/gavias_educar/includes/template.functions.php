...
function gavias_educar_breadcrumb($variables) {
 ...
 */
function gavias_educar_button($variables) {
 ...
 */
function gavias_educar_preprocess_comment(&$vars) {
 ...
 */
function gavias_educar_container($variables) {
  $element = $variables['element'];
 ...
 */
function gavias_educar_date($variables) {
  $element = $variables['element'];
 ...
 */
function gavias_educar_exposed_filters($variables) {
  $form = $variables['form'];
  $output = '';
 ...
 */
function gavias_educar_process_html_tag(&$variables) {
 ...
 */
function gavias_educar_preprocess_links(&$variables) {
 ...
 */
function gavias_educar_item_list($variables) {
 ...
 */
function gavias_educar_status_messages($variables) {
 ...
 */
function gavias_educar_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function gavias_educar_menu_tree(&$variables) {
  return '<ul class="menu nav">' . $variables['tree'] . '</ul>';
}

/**
 * gavias_educar theme wrapper function for the primary menu links.
 */
function gavias_educar_menu_tree__primary(&$variables) {
  return '<ul class="menu nav navbar-nav">' . $variables['tree'] . '</ul>';
}

/**
 * gavias_educar theme wrapper function for the secondary menu links.
 */
function gavias_educar_menu_tree__secondary(&$variables) {
 ...
 */
function gavias_educar_menu_link(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
  if ($element['#below']) {
